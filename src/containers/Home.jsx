...
import ResumePDF from "../assets/pdf/JairUribe.pdf";
    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 w-full">
        <div className="w-full h-full flex flex-col items-center lg:item-start justify-center gap-4">
          ...
          <h2 className="block tracking-wider text-2xl text-center lg:text-4xl text-texlight mt-4">
            {" "}
          ...
          <p className="text-base text-texlight mt-6 text-center lg:text-left pb-7">
            ...
            impulsándome a adaptarme a diversos entornos de trabajo.
          </p>
